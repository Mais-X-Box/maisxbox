...
class HomePageListBlockXboxStore extends StatelessWidget {
  final HomePresenter presenter;
  const HomePageListBlockXboxStore({required this.presenter});
  ...
  Widget build(BuildContext context) {
    return Observer(builder: (_) {
      return HomePageListBlockBase(
        ...
        list: this.presenter.homeViewModel.gamesXboxStore,
      );
    });
  }
}
